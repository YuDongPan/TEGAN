...
# parser.add_argument('--ws', type=float, default=2.0, help="window size of ssvep")
# parser.add_argument('--Kf', type=int, default=1, help="k-fold cross validation")
...
Ploter.plot_save_Result(final_acc_list, model_name='CCA', dataset=save_dataset, UD=opt.UD, ratio=opt.ratio,
