...
#             eeg_gen_train[train_idx, :, :, :] = eeg_generator(z.float())[0].detach()
...
Ploter.plot_save_Result(final_acc_list, model_name='C_CNN', dataset=save_dataset, UD=opt.UD, ratio=opt.ratio,
